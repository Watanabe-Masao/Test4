...
> 内部向けの詳細変更記��は `references/04-tracking/recent-changes.generated.md` を参照。
...
- **generated project-health**: `references/04-tracking/generated/project-health.{json,md}` を docs:generate で生成。全 project の derivedStatus + progress を一覧化
...
- **references/04-tracking/recent-changes.generated.md**: #673-#692 の変更詳細を別紙化
- **references/03-implementation/coding-conventions.md**: CLAUDE.md から抽出
