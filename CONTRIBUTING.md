...
3. **references/01-foundation/design-principles.md** — 9カテゴリ（A-H + Q）の設計原則
4. **references/04-tracking/features-migration-status.md** — 現在の移行状況
...
詳細・適用例は `references/01-foundation/design-principles.md` を参照してください。
