...
- `references/03-implementation/metric-id-registry.md` — MetricId 一覧（**必読**、81指標定義済み/50指標文書化済み）
- `references/03-implementation/explanation-architecture.md` — Explanation 詳細アーキテクチャ
