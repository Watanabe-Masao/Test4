...
describe('calculateStoreResult', () => {
  ...
  it('売変データの集計', () => {
    const data = buildTestData({
      classifiedSales: {
        records: [makeCSRecord(1, '1', 50000, 5000)],
      },
    })
    ...
    const data = buildTestData({
      classifiedSales: {
        records: [
          ...
          makeCSRecord(10, '1', 30000),
          makeCSRecord(15, '1', 40000),
        ],
      },
      purchase: {
        records: [
  ...
  it('dataEndDay が null の場合は全日集計', () => {
    const data = buildTestData({
      classifiedSales: {
        records: [
          makeCSRecord(1, '1', 10000),
          makeCSRecord(15, '1', 20000),
          makeCSRecord(28, '1', 30000),
        ],
      },
    })
...
describe('客数集計', () => {
  it('花データの客数が集計される', () => {
    const data = buildTestData({
      ...
      flowers: {
        records: [
          { year: 2025, month: 1, day: 1, storeId: '1', price: 0, cost: 0, customers: 30 },
          { year: 2025, month: 1, day: 2, storeId: '1', price: 0, cost: 0, customers: 40 },
        ],
      },
    })
  ...
  it('aggregateStoreResults で客数が合算される', () => {
    const data: MonthlyData = {
      ...
      flowers: {
        records: [
          { year: 2025, month: 1, day: 1, storeId: '1', price: 0, cost: 0, customers: 30 },
          { year: 2025, month: 1, day: 1, storeId: '2', price: 0, cost: 0, customers: 50 },
        ],
      },
    }
    ...
    const data = buildTestData({
      classifiedSales: {
        records: [
          ...
          makeCSRecord(10, '1', 60000),
          makeCSRecord(20, '1', 70000),
        ],
      },
      flowers: {
        records: [
          { year: 2025, month: 1, day: 1, storeId: '1', price: 0, cost: 0, customers: 30 },
          { year: 2025, month: 1, day: 10, storeId: '1', price: 0, cost: 0, customers: 40 },
          { year: 2025, month: 1, day: 20, storeId: '1', price: 0, cost: 0, customers: 50 },
        ],
      },
    })
