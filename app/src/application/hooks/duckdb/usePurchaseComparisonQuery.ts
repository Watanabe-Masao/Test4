...
function buildSupplierAndCategoryData(
  curSuppliers: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').PurchaseSupplierRow[],
  prevSuppliers: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').PurchaseSupplierRow[],
  curTotal: { totalCost: number; totalPrice: number },
  prevTotal: { totalCost: number; totalPrice: number },
  supplierCategoryMap: Readonly<Partial<Record<string, CustomCategoryId>>>,
  userCategories: ReadonlyMap<string, string>,
...
function buildDailyData(
  curDaily: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').PurchaseDailyRow[],
  prevDaily: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').PurchaseDailyRow[],
  curSalesDaily: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').SalesDailyRow[],
  prevSalesDaily: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').SalesDailyRow[],
): PurchaseDailyData {
...
function buildStoreData(
  curStores: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').PurchaseStoreRow[],
  prevStores: readonly import('@/infrastructure/duckdb/queries/purchaseComparison').PurchaseStoreRow[],
  storeNames: ReadonlyMap<string, string>,
): StoreComparisonRow[] {
