...
const DrillPanel = styled.div<{ $color: string }>`
...
const DrillDay = styled.div<{ $intensity: number; $color: string }>`
  padding: 3px 2px;
  text-align: center;
  border-radius: 3px;
  font-size: 0.55rem;
...
const DrillDayLabel = styled.div`
  font-size: 0.45rem;
  color: ${({ theme }) => theme.colors.text4};
`

const DrillDayValue = styled.div`
  font-weight: 600;
  font-size: 0.55rem;
`

const DrillSummary = styled.div`
  display: flex;
