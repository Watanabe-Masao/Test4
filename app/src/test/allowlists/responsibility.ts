...
export const moduleScopeLetLimits: readonly QuantitativeAllowlistEntry[] = [
  {
    ...
    reason: 'WASM エンジンのシングルトン管理。module let 16 個（current 6 + candidate 10）',
    category: 'structural',
  ...
  {
    path: 'application/services/piValueBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
  ...
  {
    path: 'application/services/remainingBudgetRateBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/trendAnalysisBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/movingAverageBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/correlationBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/sensitivityBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/inventoryCalcBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/pinIntervalsBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/observationPeriodBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
  ...
  {
    path: 'application/services/customerGapBridge.ts',
    ruleId: 'AR-RESP-MODULE-STATE',
    reason: 'Candidate bridge のモード管理 + dual-run 結果保持。module let 2 個',
    category: 'structural',
    removalCondition: 'Phase 8 Promote Ceremony 完了後、current bridge に統合時',
