...
function makeDailyRecord(overrides: {
  ...
  return {
    ...
    // Derived
    coreSales: (overrides.sales ?? 0) - (overrides.flowers?.price ?? 0) - (overrides.directProduce?.price ?? 0),
...
describe('inventoryCalc', () => {
  describe('computeEstimatedInventoryDetails', () => {
    ...
    it('should compute inventory with purchase and sales data', () => {
      ...
      const result = computeEstimatedInventoryDetails(
        daily, 1, 50000, null, 0.25, 0.0,
      )
