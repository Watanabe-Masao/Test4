...
- `references/03-guides/contract-definition-policy.md` — ANA 契約テンプレート
- `references/03-guides/current-maintenance-policy.md` — current/analytics 保守観点
- `references/03-guides/tier1-business-migration-plan.md` — Phase 5 との対比
