...
2. **advisory の場合**: push は止まらない。ただし以下を行う:
   ...
   - 自己点検が「該当する」なら修正
   - 誤検知の場合、`projects/test-signal-integrity` の HANDOFF §3 に該当
     パターンを記録（蓄積データ）
...
- [`projects/test-signal-integrity/plan.md`](../../projects/test-signal-integrity/plan.md) — 実装計画と Phase 構造
- [`projects/test-signal-integrity/checklist.md`](../../projects/test-signal-integrity/checklist.md) — required checkbox 集合
