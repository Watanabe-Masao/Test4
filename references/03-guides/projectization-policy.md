...
| `requiresHumanApproval` | 設計判断で人間承認が必要か | true / false |
...
- checklist の最終レビュー section に **人間承認 checkbox** 必須
...
true の場合、`checklist.md` の最終レビュー (人間承認) section に
以下の形式で checkbox を持つ:
...
- `config/project.json` の `projectization` フィールドの **人間可読 view**
