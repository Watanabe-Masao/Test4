...
- `references/01-principles/aag-*.md`（AAG 正本系）
- `references/01-principles/canonicalization-principles.md` / `taxonomy-constitution.md`
...
- [x] `references/01-principles/aag-*` / `AAG_*.md`
