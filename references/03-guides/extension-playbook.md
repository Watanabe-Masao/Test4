...
- [ ] `references/03-guides/metric-id-registry.md` に登録（ID・ラベル・計算式・ソース）
...
- [ ] 必要なら `references/03-guides/calculation-engine.md` を更新
...
- [ ] `references/01-principles/engine-responsibility.md` を確認
...
- [ ] `references/01-principles/engine-responsibility.md` を更新
- [ ] `references/03-guides/duckdb-architecture.md` に追記（必要な場合）
