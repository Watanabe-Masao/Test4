...
>
> **位置付け**: 四半期 review window の **手続き** は `references/03-guides/taxonomy-review-window.md` が正本。本ガイドはテスト軸固有の **入力情報 / 出力検証 / 同期通知** に特化（重複しない）。
>
...
| T:kind schema 仕様                          | `references/01-principles/test-taxonomy-schema.md`         |
| R⇔T Interlock マトリクス                   | `references/01-principles/taxonomy-interlock.md`           |
| T:kind Origin 採取                          | `references/01-principles/taxonomy-origin-journal.md` §T   |
| TSIG → v2 移行表                            | `references/03-guides/test-tsig-to-v2-migration-map.md`    |
...
以下のイベント発生時、`projects/responsibility-taxonomy-v2/HANDOFF.md` に同期通知を記載 + 兄弟ガイド `responsibility-taxonomy-operations.md` §4 の対応 trigger を参照する:
...
| `references/03-guides/responsibility-taxonomy-operations.md`       | 責務軸 operations 兄弟ガイド（§4 同期対象）        |
| `references/03-guides/test-tsig-to-v2-migration-map.md`            | TSIG → v2 移行表（Phase 7 撤退対象 mapping）        |
| `references/01-principles/taxonomy-constitution.md`                | 7 不可侵原則（本ガイドは原則 2 + 4 + 6 + 7 の運用） |
| `references/01-principles/test-taxonomy-schema.md`                 | T:kind schema 仕様正本                              |
| `references/01-principles/taxonomy-interlock.md`                   | R⇔T Interlock マトリクス正本                       |
| `references/01-principles/taxonomy-origin-journal.md` §T           | T:kind Origin 採取の正本                            |
...
| `projects/test-taxonomy-v2/plan.md`                                | 子 project plan（10 Phase + Phase 別禁止事項）      |
| `projects/test-taxonomy-v2/checklist.md`                           | 子 project completion 入力                          |
