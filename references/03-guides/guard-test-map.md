...
| `app/src/test/guards/taxonomyV1V2GapGuard.test.ts` | documentation-steward | 4件 | taxonomy-v2 子 Phase 6b v1/v2 ギャップ guard（GAP-R-0 smoke / GAP-R-1 v1-only tagged file baseline=259 ratchet-down / GAP-R-2 v2-only 分布情報出力 / GAP-R-3 両軸分布全体サマリ）。Phase 7 v1 deprecation までに GAP-R-1 = 0 達成、Phase 8 v1 retirement で v1 vocabulary 物理削除。 |
