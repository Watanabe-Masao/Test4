...
- Discovery Review チェックリスト: 26 項目（`references/03-implementation/discovery-review-checklist.md`）
...
- `references/03-implementation/purchase-cost-unification-plan.md` — 取得経路統合計画
