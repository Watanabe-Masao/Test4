...
| ---------------- | -------------------------------------------------------- | --------------------------------- |
| `AR-001`         | `references/03-implementation/safety-first-architecture-plan.md` | `AAG-REQ-RATCHET-DOWN`            |
| `AR-002`         | `references/01-foundation/design-principles.md`          | `AAG-REQ-LAYER-SEPARATION`        |
| `AR-A1-DOMAIN`   | `references/01-foundation/design-principles.md`          | `AAG-REQ-LAYER-SEPARATION`        |
| `AR-G3-SUPPRESS` | `references/03-implementation/coding-conventions.md`             | `AAG-REQ-NON-PERFORMATIVE`        |
| `AR-005`         | `references/01-foundation/modular-monolith-evolution.md` | `AAG-REQ-RATCHET-DOWN`            |
