...
詳細: `references/03-implementation/promote-ceremony-pr-template.md`
...
**設計理由**: spec は「物理実装の事実台帳」（`references/04-tracking/elements/README.md`）。
...
# 業務意味の正本リンク
definitionDoc: references/01-foundation/customer-gap-definition.md
