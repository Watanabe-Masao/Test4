...
| 全 project の checked checkbox 総数 | 1162 |
...
| `aag-engine-readiness-refactor` | AAG Engine Readiness Refactor — Go/Rust engine 実装前の TS 構造事前整備 | **in_progress** | — | 22/41 (54%) | [`projects/active/aag-engine-readiness-refactor/AI_CONTEXT.md`](../../../projects/active/aag-engine-readiness-refactor/AI_CONTEXT.md) |
