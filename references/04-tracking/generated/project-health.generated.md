...
| 全 project の required checkbox 総数 | 1305 |
| 全 project の checked checkbox 総数 | 1219 |
...
| `reposteward-ai-ops-platform` | RepoSteward AI Ops Platform — AI-first repo operations engine への進化 (= post-MVP) | **in_progress** | — | 79/86 (92%) | [`projects/active/reposteward-ai-ops-platform/AI_CONTEXT.md`](../../../projects/active/reposteward-ai-ops-platform/AI_CONTEXT.md) |
