...
| 全 project の checked checkbox 総数 | 1168 |
...
| `aag-engine-go-mvp` | AAG Engine Go MVP — read-only governance validator shadow implementation | **in_progress** | — | 28/72 (39%) | [`projects/active/aag-engine-go-mvp/AI_CONTEXT.md`](../../../projects/active/aag-engine-go-mvp/AI_CONTEXT.md) |
