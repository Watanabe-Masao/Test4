...
| 全 project の checked checkbox 総数 | 1163 |
...
| `aag-engine-go-mvp` | AAG Engine Go MVP — read-only governance validator shadow implementation | **in_progress** | — | 23/72 (32%) | [`projects/active/aag-engine-go-mvp/AI_CONTEXT.md`](../../../projects/active/aag-engine-go-mvp/AI_CONTEXT.md) |
