...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 4/20 / in_progress な project 数（open required checkbox あり）: 3/20 / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 39/100 |
