...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 6/20 (+1) / in_progress な project 数（open required checkbox あり）: 5/20 (+1) / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 41/100 |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の required checkbox 総数 | 1430 | 1457 | +27 ! |
