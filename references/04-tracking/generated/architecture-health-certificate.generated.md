...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 5/20 (-1) / in_progress な project 数（open required checkbox あり）: 4/20 (-1) / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 46/100 (+1) |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| archived project 数（projects/completed/ 配下） | 45 | 46 | +1 ! |
| 全 project の required checkbox 総数 | 2199 | 2175 | -24 + |
| 全 project の checked checkbox 総数 | 2093 | 2083 | -10 + |
