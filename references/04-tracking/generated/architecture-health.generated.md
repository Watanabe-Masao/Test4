...
> Generated: 2026-05-15T10:00:26.464Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 141 / 30 | OK |
...
| project.checklist.archivedCount | archived project 数（projects/completed/ 配下） | 46 / 100 | OK |
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 2175 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 2083 | OK |
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| perf.bundle.totalJsKb | JS バンドル合計サイズ | 6612 / 7000 | OK |
