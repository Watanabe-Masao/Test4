...
| `references/03-implementation/authoritative-display-rules.md` | 10 | displayMode 文書 |
...
| ファイル | 件数 | 備考 |
|---------|------|------|
| `references/04-tracking/engine-promotion-matrix.md` | 25 | 全5 engine を区別なく authoritative と記載 |
| `references/01-foundation/engine-boundary-policy.md` | 14 | Phase 0 で主要箇所を修正済み |
| `references/04-tracking/promotion-criteria.md` | 12 | 昇格条件定義。Phase 4 で修正 |
| `references/03-implementation/rollback-policy.md` | 7 | rollback 方針。Phase 7 で修正 |
| `references/04-tracking/recent-changes.generated.md` | 5 | 変更履歴。必要時に修正 |
| `CLAUDE.md` | 5 | Phase 0 で修正 |
| `references/README.md` | 4 | 参照索引。必要時に修正 |
| `references/04-tracking/frozen-list.md` | 4 | 凍結リスト。Phase 4 で修正 |
