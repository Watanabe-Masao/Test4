...
| 文書 | 役割 |
|---|---|
| `references/01-foundation/taxonomy-constitution.md` | 7 不可侵原則（本マトリクスは原則 4 の詳細） |
| `references/01-foundation/taxonomy-origin-journal.md` | 各タグの Origin（採択経緯） |
| `projects/active/taxonomy-v2/plan.md` | §AR-TAXONOMY-* 仕様正本 / §OCS.7 Anchor Slice |
