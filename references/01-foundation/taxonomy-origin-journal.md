...
> 対応 inventory 正本: `references/04-tracking/responsibility-taxonomy-inventory.yaml`（CanonEntry 1370 entry）
...
inventory 正本: `references/04-tracking/responsibility-taxonomy-inventory.yaml`（5 directories scope: application/ + domain/ + features/ + infrastructure/ + presentation/ + test/guards/、計 1370 entry）
...
> 上表「inventory 件数」は責務軸 inventory `references/04-tracking/responsibility-taxonomy-inventory.yaml`
...
> 対応 schema 正本: `references/01-foundation/responsibility-taxonomy-schema.md`
...
> 対応 inventory 正本: `references/04-tracking/test-taxonomy-inventory.yaml`（CanonEntry 728 entry）
...
>
> **inventory 件数の由来:** テスト軸 inventory `references/04-tracking/test-taxonomy-inventory.yaml` の
...
> 対応 schema 正本: `references/01-foundation/test-taxonomy-schema.md`
...
| 文書                                                                            | 役割                                                                     |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `references/01-foundation/taxonomy-constitution.md`                             | 7 不可侵原則（本 journal は原則 5 の正本）                               |
| `references/01-foundation/taxonomy-interlock.md`                                | R ⇔ T マトリクス（本 journal の各タグが Interlock 上の役割を持つ）       |
| `projects/active/taxonomy-v2/plan.md`                                                  | 親 plan §OCS.2 Evidence Level / §OCS.4 Lifecycle / §OCS.5 Promotion Gate |
| `projects/completed/responsibility-taxonomy-v2/plan.md` Phase 0                           | 子: 責務軸 v1 タグの採取                                                 |
| `projects/completed/test-taxonomy-v2/plan.md` Phase 0                                     | 子: テスト軸 v1 TSIG-\* の採取                                           |
| `references/04-tracking/responsibility-taxonomy-inventory.yaml`（Phase 0 で生成） | 採取結果の YAML 正本                                                     |
| `references/04-tracking/test-taxonomy-inventory.yaml`（Phase 0 で生成）           | 採取結果の YAML 正本                                                     |
| `references/04-tracking/taxonomy-review-journal.md`（Phase 2 で landing）         | 各 review window の追加・撤退・却下記録                                  |
