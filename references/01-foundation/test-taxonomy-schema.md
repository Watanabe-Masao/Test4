...
| 文書                                                    | 役割                                                                |
| ------------------------------------------------------- | ------------------------------------------------------------------- |
| `references/01-foundation/taxonomy-constitution.md`     | 7 不可侵原則（本 schema は原則 1, 2, 4, 6, 7 の実装）               |
| `references/01-foundation/taxonomy-interlock.md`        | R⇔T 完全マトリクス（本 schema § Interlock 検証対象 R:tag 列の正本） |
| `references/01-foundation/taxonomy-origin-journal.md`   | 各 T:kind の Origin (Why/When/Who/Sunset)（§4 で landing）          |
