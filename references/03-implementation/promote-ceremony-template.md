...
**判定主体は「AAG 証拠収集 → AI 提案 → user 承認」。実装 AI の自己承認は禁止。**
...
- `references/03-implementation/tier1-business-migration-plan.md` — Phase 5 の promotion-ready 判定基準
- `references/03-implementation/analytic-kernel-migration-plan.md` — Phase 6 の promotion-ready 判定基準
- `references/03-implementation/guard-consolidation-and-js-retirement.md` — 全 guard マップ
- `references/03-implementation/current-maintenance-policy.md` — 昇格後は current 群の保守ポリシーに従う
