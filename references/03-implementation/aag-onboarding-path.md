...
| 2 | `references/01-foundation/design-principles.md` | 必要時 — 各原則の詳細 |
| 3 | `references/03-implementation/coding-conventions.md` | 必要時 — strict mode / パスエイリアス / 命名規約 |
...
| 2 | 該当する業務値の定義書 | 5-10 分 — `references/01-foundation/<業務値>-definition.md` |
| 3 | `references/01-foundation/canonicalization-principles.md` | 必要時 — P1-P9 の正本化原則 |
...
| 3 | `references/03-implementation/aag-change-impact-template.md`（Q.M-1 deliverable） | PR description の必須 section |
| 4 | `references/03-implementation/architecture-rule-system.md` | 必要時 — rule 運用ガイド |
| 5 | `references/03-implementation/allowlist-management.md` | allowlist 関連時 |
...
| 2 | `references/03-implementation/guard-failure-playbook.md`（Q.O-4 deliverable） | Repair-style 標準 |
...
| 順 | doc | 所要 |
|---|---|---|
| 1 | `references/03-implementation/duckdb-architecture.md` | 5 分 — Q1-Q6 rule + Query Access |
| 2 | `references/01-foundation/engine-boundary-policy.md` | 5 分 — 3 engine の境界 |
| 3 | `references/01-foundation/engine-responsibility.md` | 必要時 — JS vs SQL の責務 |
