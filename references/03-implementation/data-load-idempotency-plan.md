...
> | 役割 | 文書 |
> |---|---|
> | 設計・歴史（本書） | `references/03-implementation/data-load-idempotency-plan.md` |
> | FRAGILE 分類根拠 | `references/03-implementation/read-path-duplicate-audit.md` |
...
（FRAGILE → SAFE 昇格）。残る FRAGILE 3, 4, 5 は audit 推奨事項上
