...
詳細は `references/01-foundation/purchase-cost-definition.md` を参照。
...
| Step 3 | store hydration / backup / IndexedDB adapter | 5箇所 (Zod safeParse + フォールバック) | ✅ |
...
- `references/01-foundation/purchase-cost-definition.md` — 仕入原価の正本定義
- `references/01-foundation/engine-boundary-policy.md` — Engine Boundary Policy
- `references/01-foundation/data-flow.md` — データフロー4段階
- `references/03-implementation/duckdb-architecture.md` — DuckDB Query Architecture
- `references/03-implementation/widget-coordination-architecture.md` — Widget Orchestrator 計画
