...
| パス                                                                              | 役割                                                  |
| --------------------------------------------------------------------------------- | ----------------------------------------------------- |
| `references/03-implementation/integrity-pair-inventory.md` (本 doc の正本入力)            | Phase A inventory + selection rule + primitive 候補   |
| `references/01-foundation/canonicalization-principles.md §P8 §P9`                 | selection rule + 撤退規律 default = step 5 直接到達   |
