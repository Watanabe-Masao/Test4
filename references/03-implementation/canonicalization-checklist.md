...
> 正本: `references/01-foundation/canonicalization-principles.md §P8`
...
> 正本: `references/03-implementation/integrity-domain-architecture.md §3` (各 primitive 責務契約)
...
> 正本: `references/01-foundation/canonicalization-principles.md §P9`
...
- [ ] `references/03-implementation/guard-test-map.md` に新 guard file を登録
...
> 正本: `references/01-foundation/canonicalization-principles.md §P9` 5 step
...
- selection rule: `references/01-foundation/canonicalization-principles.md §P8`
- 撤退規律: 同 §P9
- domain 設計: `references/03-implementation/integrity-domain-architecture.md`
- inventory: `references/03-implementation/integrity-pair-inventory.md`
