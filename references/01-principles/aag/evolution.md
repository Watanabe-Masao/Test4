...
- **個別 rule の articulate** (検出ロジック / pattern / migrationRecipe) → `references/03-guides/architecture-rule-system.md` + `base-rules.ts`
...
| `references/03-guides/architecture-rule-system.md` | AR-rule 運用ガイド (Layer 4A System Operations) |
| `references/03-guides/allowlist-management.md` | allowlist 管理手順 |
| `references/03-guides/promote-ceremony-template.md` | 昇格手順 (実験 → 正規) |
