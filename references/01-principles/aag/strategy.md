...
## §3 戦略適用範囲 (in-scope vs out-of-scope)

### §3.1 in-scope (AAG が担う)
...
## §6 旧 戦略マスター → 新 戦略 mapping (`§1.5 archive 前 mapping 義務`)
...
| 戦略の進化方針 | 本 doc §4 + [`evolution.md`](./evolution.md) |
...
| 関連文書 table | 本 doc §7 関連 doc + [`README.md`](./README.md) (aag/ ディレクトリ index) |
