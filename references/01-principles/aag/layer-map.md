...
| `references/01-principles/sales-definition.md` 等 業務値定義書 | sales / discount / customer / gross-profit ほか各業務値の正本 articulate |

### §3.3 縦スライス: query-runtime

| file | 役割 |
|---|---|
| `references/01-principles/engine-boundary-policy.md` | 3 エンジン境界 (Authoritative / Application / Exploration) |
| `references/01-principles/engine-responsibility.md` | JS vs DuckDB 責務 |
| `references/01-principles/data-flow.md` | 4 段階データフロー |
...
| file | 役割 |
|---|---|
| `references/01-principles/design-principles.md` | 9 カテゴリ設計原則 (A-I + Q) |
...
| `references/01-principles/responsibility-taxonomy-schema.md` | 責務タグ schema (v2) |
...
| `references/02-status/generated/` | 生成済みレポート (派生物、手編集禁止) |
