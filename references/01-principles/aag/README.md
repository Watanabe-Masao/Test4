...
旧 `references/01-principles/` flat 構造に landing している以下の doc は、Phase 5 で archive 移管予定 (`projects/aag-bidirectional-integrity/legacy-retirement.md` 参照):
...
| `aag-5-layer-map.md` | `aag/layer-map.md` |
...
| `projects/aag-bidirectional-integrity/AI_CONTEXT.md` | 本 ディレクトリを landing する project の文脈 |
| `projects/aag-bidirectional-integrity/plan.md` | canonical 計画 doc (Phase 1〜10 + 不可侵原則 + §8 確認・調査事項) |
