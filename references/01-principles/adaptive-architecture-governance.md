...
| 92 ルールの運用区分 | `aag-operational-classification.md` |
...
> 生成: 2026-04-09T08:01:01.409Z — 正本: `app/src/test/architectureRules.ts`
...
- [ ] **メンテナンスコストに見合うか？** 92 ルール × 新フィールド = メンテナンス負債
...
| `references/01-principles/aag-operational-classification.md` | 運用区分表（即修正/構造負債/観測 × 92 ルール） |
