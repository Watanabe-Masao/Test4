...
詳細: `references/99-archive/aag-four-layer-architecture.md`
...
> 生成: 2026-04-30T20:51:02.674Z — 正本: `app/src/test/architectureRules.ts`
<!-- GENERATED:END aag-rule-stats -->

## 運用区分

詳細: `references/99-archive/aag-operational-classification.md`
...
詳細: `references/99-archive/adaptive-governance-evolution.md`
...
| 文書 | 内容 |
|------|------|
| `references/99-archive/adaptive-governance-evolution.md` | 進化の設計原則（3層サイクル） |
| `references/99-archive/aag-four-layer-architecture.md` | 4 層定義（Principles/Judgment/Detection/Response） |
| `references/99-archive/aag-operational-classification.md` | 運用区分表（即修正/構造負債/観測） |
| `references/99-archive/aag-rule-splitting-plan.md` | ルール分割計画（例外圧 → protected harm ベース） |
