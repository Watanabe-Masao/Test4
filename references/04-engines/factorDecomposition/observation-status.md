...
`references/03-guides/wasm-dual-run-runbook.md` セクション 8.4 に準拠する。
...
- **Runbook:** `references/03-guides/wasm-dual-run-runbook.md` に運用手順・分類フレームワーク・昇格基準が文書化済み
...
| `references/03-guides/wasm-dual-run-runbook.md` | 運用手順・分類・昇格基準 |
