...
|---|---|---|---|
| `architecture-debt-recovery` | umbrella | アーキテクチャ負債回収（widget 起点の大型改修） — Phase 1-5 完了、Phase 6 全 sub-project (SP-A/B/C/D) 完遂。Phase 7 (umbrella archive) のみ残 | [`projects/architecture-debt-recovery/AI_CONTEXT.md`](../../projects/architecture-debt-recovery/AI_CONTEXT.md) |
