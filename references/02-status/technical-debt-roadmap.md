...
> 生成: 2026-04-05T13:58:18.810Z — 正本: `references/02-status/generated/architecture-health.json`
...
- **WASM dual-run bridge:** 5件残存（`compat.bridge.count` で管理）。4 engine が promotion-candidate、1 engine が bridge-ready。詳細は `engine-promotion-matrix.md` を参照
