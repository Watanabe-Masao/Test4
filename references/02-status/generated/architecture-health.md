...
> Generated: 2026-04-10T15:27:31.756Z
> Schema: v1.0.0
...
| guard.rules.total | 総 Architecture Rule 数 | 109 | OK |
| guard.rules.fixNow.now | fixNow=now ルール数（即修正） | 40 | OK |
| guard.rules.fixNow.debt | fixNow=debt ルール数（構造負債） | 50 | OK |
| guard.rules.fixNow.review | fixNow=review ルール数（観測） | 21 | OK |
| temporal.rules.reviewPolicy.count | reviewPolicy 設定済みルール数 | 109 / 92 | OK |
...
| efficacy.rules.withProtectedHarm.count | protectedHarm 設定済みルール数 | 46 | OK |
