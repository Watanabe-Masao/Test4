...
> Generated: 2026-05-01T08:26:04.943Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 126 / 30 | OK |
...
| temporal.rules.reviewPolicy.count | reviewPolicy 設定済みルール数 | 171 / 92 | OK |
...
| project.checklist.archivedCount | archived project 数（projects/completed/ 配下） | 34 / 100 | OK |
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 1189 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 1123 | OK |
