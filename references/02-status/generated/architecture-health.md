...
> Generated: 2026-04-12T22:24:11.854Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 56 / 30 | OK |
...
| project.checklist.archivedCount | archived project 数（projects/completed/ 配下） | 2 / 100 | OK |
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 302 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 195 | OK |
