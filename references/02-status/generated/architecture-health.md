...
> Generated: 2026-04-15T03:53:02.963Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 63 / 30 | OK |
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 368 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 307 | OK |
