...
> Generated: 2026-04-06T01:33:28.398Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 36 / 30 | OK |
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| perf.bundle.totalJsKb | JS バンドル合計サイズ | 6447 / 7000 | OK |
| perf.bundle.mainJsKb | メインバンドルサイズ | 2217 / 2500 | OK |
