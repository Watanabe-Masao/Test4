...
> Generated: 2026-04-24T21:40:30.740Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 87 / 30 | OK |
...
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 597 | OK |
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| perf.bundle.totalJsKb | JS バンドル合計サイズ | 6600 / 7000 | OK |
