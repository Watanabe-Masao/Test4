...
> Generated: 2026-04-18T08:27:16.642Z
> Schema: v1.0.0
...
| project.checklist.archivedCount | archived project 数（projects/completed/ 配下） | 11 / 100 | OK |
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 462 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 421 | OK |
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| perf.bundle.totalJsKb | JS バンドル合計サイズ | 6535 / 7000 | OK |
