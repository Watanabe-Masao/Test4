...
> Generated: 2026-04-23T07:46:45.629Z
> Schema: v1.0.0
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 652 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 513 | OK |
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| perf.bundle.totalJsKb | JS バンドル合計サイズ | 6630 / 7000 | OK |
| perf.bundle.mainJsKb | メインバンドルサイズ | 2329 / 2500 | OK |
