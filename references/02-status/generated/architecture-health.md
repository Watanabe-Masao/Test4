...
> Generated: 2026-04-26T14:16:54.272Z
> Schema: v1.0.0
...
| ID | 指標 | 値 | 状態 |
|---|---|---|---|
| guard.files.count | ガードテストファイル数 | 101 / 30 | OK |
...
| project.checklist.totalCheckboxes | 全 project の required checkbox 総数 | 839 | OK |
| project.checklist.checkedCheckboxes | 全 project の checked checkbox 総数 | 701 | OK |
