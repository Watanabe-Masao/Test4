...
| 指標 | 値 |
|------|-----|
| ADR (remediation item) | 18 |
| Breaking Change | 7 |
| Legacy Retirement | 15 |
| Sub-Project | 4 |
| Guard Implemented (PR landed) | 26 |
...
|---|---|---|---|
| widget-context-boundary | 1 | 35 | 2.9% |
| duplicate-orphan-retirement | 15 | 25 | 60.0% |
| aag-temporal-governance-hardening | 10 | 29 | 34.5% |
