...
| 全 project の checked checkbox 総数 | 575 |
...
| `duplicate-orphan-retirement` | 複製 / orphan 撤退（SP-C） | **in_progress** | `architecture-debt-recovery` | 5/25 (20%) | [`projects/duplicate-orphan-retirement/AI_CONTEXT.md`](../../../projects/duplicate-orphan-retirement/AI_CONTEXT.md) |
