...
| 全 project の checked checkbox 総数 | 613 |
...
| `widget-context-boundary` | widget / ctx 型境界再構築（SP-A） | **in_progress** | `architecture-debt-recovery` | 18/33 (55%) | [`projects/widget-context-boundary/AI_CONTEXT.md`](../../../projects/widget-context-boundary/AI_CONTEXT.md) |
