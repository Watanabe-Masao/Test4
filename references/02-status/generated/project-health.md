...
| 全 project の checked checkbox 総数 | 591 |
...
| `aag-temporal-governance-hardening` | AAG / Temporal Governance 強化（SP-D） | **in_progress** | `architecture-debt-recovery` | 10/29 (35%) | [`projects/aag-temporal-governance-hardening/AI_CONTEXT.md`](../../../projects/aag-temporal-governance-hardening/AI_CONTEXT.md) |
