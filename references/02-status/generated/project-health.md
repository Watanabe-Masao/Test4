...
| 全 project の required checkbox 総数 | 653 |
| 全 project の checked checkbox 総数 | 499 |
...
| `budget-achievement-simulator` | 予算達成シミュレーター | **in_progress** | — | 29/46 (63%) | [`projects/budget-achievement-simulator/AI_CONTEXT.md`](../../../projects/budget-achievement-simulator/AI_CONTEXT.md) |
