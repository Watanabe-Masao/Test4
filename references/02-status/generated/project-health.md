...
| 全 project の required checkbox 総数 | 650 |
| 全 project の checked checkbox 総数 | 495 |
...
| `budget-achievement-simulator` | 予算達成シミュレーター | **in_progress** | — | 25/43 (58%) | [`projects/budget-achievement-simulator/AI_CONTEXT.md`](../../../projects/budget-achievement-simulator/AI_CONTEXT.md) |
