...
| 全 project の checked checkbox 総数 | 307 |
...
| `unify-period-analysis` | 期間分析統合（固定期間を自由期間プリセットに） | **in_progress** | — | 21/49 (43%) | [`projects/unify-period-analysis/AI_CONTEXT.md`](../../../projects/unify-period-analysis/AI_CONTEXT.md) |
