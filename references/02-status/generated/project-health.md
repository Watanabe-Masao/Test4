...
| 全 project の checked checkbox 総数 | 573 |
...
| `duplicate-orphan-retirement` | 複製 / orphan 撤退（SP-C） | **in_progress** | `architecture-debt-recovery` | 3/25 (12%) | [`projects/duplicate-orphan-retirement/AI_CONTEXT.md`](../../../projects/duplicate-orphan-retirement/AI_CONTEXT.md) |
