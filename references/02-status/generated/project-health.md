...
| 全 project の checked checkbox 総数 | 586 |
...
| `aag-temporal-governance-hardening` | AAG / Temporal Governance 強化（SP-D） | **in_progress** | `architecture-debt-recovery` | 5/29 (17%) | [`projects/aag-temporal-governance-hardening/AI_CONTEXT.md`](../../../projects/aag-temporal-governance-hardening/AI_CONTEXT.md) |
