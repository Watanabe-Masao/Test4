...
| 全 project の required checkbox 総数 | 369 |
| 全 project の checked checkbox 総数 | 316 |
...
| `unify-period-analysis` | 期間分析統合（固定期間を自由期間プリセットに） | **in_progress** | — | 30/50 (60%) | [`projects/unify-period-analysis/AI_CONTEXT.md`](../../../projects/unify-period-analysis/AI_CONTEXT.md) |
