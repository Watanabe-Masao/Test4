...
| 全 project の checked checkbox 総数 | 321 |
...
| `aag-format-redesign` | AAG フォーマット改修とサブプロジェクト機能 | **in_progress** | — | 35/36 (97%) | [`projects/aag-format-redesign/AI_CONTEXT.md`](../../../projects/aag-format-redesign/AI_CONTEXT.md) |
...
| `unify-period-analysis` | 期間分析統合（固定期間を自由期間プリセットに） | **in_progress** | — | 0/49 (0%) | [`projects/unify-period-analysis/AI_CONTEXT.md`](../../../projects/unify-period-analysis/AI_CONTEXT.md) |
