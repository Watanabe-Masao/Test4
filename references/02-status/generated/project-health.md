...
| 全 project の required checkbox 総数 | 579 |
| 全 project の checked checkbox 総数 | 487 |
...
| `category-leaf-daily-entry-shape-break` | CategoryLeafDailyEntry 独立構造化 — alias 解除で presentation を raw 型から完全隔離 (Option B 平坦化) | **in_progress** | — | 0/22 (0%) | [`projects/category-leaf-daily-entry-shape-break/AI_CONTEXT.md`](../../../projects/category-leaf-daily-entry-shape-break/AI_CONTEXT.md) |
...
| `day-detail-modal-prev-year-investigation` | DayDetailModal 前年データ空表示バグ調査 — 3/5-factor / 時間帯分析 / ドリルダウンが表示されない原因の特定 | **in_progress** | — | 12/13 (92%) | [`projects/day-detail-modal-prev-year-investigation/AI_CONTEXT.md`](../../../projects/day-detail-modal-prev-year-investigation/AI_CONTEXT.md) |
...
| `presentation-quality-hardening` | Presentation 品質強化 — テスト・E2E・active-debt 解消 | **in_progress** | — | 12/15 (80%) | [`projects/presentation-quality-hardening/AI_CONTEXT.md`](../../../projects/presentation-quality-hardening/AI_CONTEXT.md) |
...
| `quick-fixes` | Quick Fixes — 文脈を必要としない単発作業の集約 | **collection** | — | 4/5 (80%) | [`projects/quick-fixes/AI_CONTEXT.md`](../../../projects/quick-fixes/AI_CONTEXT.md) |
