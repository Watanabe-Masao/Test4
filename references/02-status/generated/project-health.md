...
| 全 project の required checkbox 総数 | 273 |
...
| `quick-fixes` | Quick Fixes — 文脈を必要としない単発作業の集約 | **collection** | 1/3 (33%) | [`projects/quick-fixes/AI_CONTEXT.md`](../../../projects/quick-fixes/AI_CONTEXT.md) |
