...
| 全 project の required checkbox 総数 | 318 |
| 全 project の checked checkbox 総数 | 262 |
...
| `presentation-quality-hardening` | Presentation 品質強化 — テスト・E2E・active-debt 解消 | **in_progress** | 0/15 (0%) | [`projects/presentation-quality-hardening/AI_CONTEXT.md`](../../../projects/presentation-quality-hardening/AI_CONTEXT.md) |
...
| `test-signal-integrity` | AAG Test Signal Integrity — 品質シグナル保全と False Green 防止 | **in_progress** | 22/34 (65%) | [`projects/test-signal-integrity/AI_CONTEXT.md`](../../../projects/test-signal-integrity/AI_CONTEXT.md) |
