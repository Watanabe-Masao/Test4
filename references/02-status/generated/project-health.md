...
| 全 project の checked checkbox 総数 | 345 |
...
| `phase-6-optional-comparison-projection` | Phase 6 optional — comparison subsystem projection context | **in_progress** | `unify-period-analysis` | 18/40 (45%) | [`projects/phase-6-optional-comparison-projection/AI_CONTEXT.md`](../../../projects/phase-6-optional-comparison-projection/AI_CONTEXT.md) |
