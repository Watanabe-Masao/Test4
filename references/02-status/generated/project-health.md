...
| 全 project の checked checkbox 総数 | 460 |
...
| `presentation-cts-surface-ratchetdown` | presentation 層の CategoryTimeSalesRecord 直接 import を 32→0 に ratchet-down | **in_progress** | — | 3/18 (17%) | [`projects/presentation-cts-surface-ratchetdown/AI_CONTEXT.md`](../../../projects/presentation-cts-surface-ratchetdown/AI_CONTEXT.md) |
