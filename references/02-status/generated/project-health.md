...
| 全 project の checked checkbox 総数 | 839 |
...
| `phased-content-specs-rollout` | Content Spec System 段階展開計画 | **in_progress** | — | 7/80 (9%) | [`projects/phased-content-specs-rollout/AI_CONTEXT.md`](../../../projects/phased-content-specs-rollout/AI_CONTEXT.md) |
...
| `responsibility-taxonomy-v2` | 責務分類 v2（子: 責務軸の Schema / Guard / Operations / Legacy 撤退） | **in_progress** | `taxonomy-v2` | 47/65 (72%) | [`projects/responsibility-taxonomy-v2/AI_CONTEXT.md`](../../../projects/responsibility-taxonomy-v2/AI_CONTEXT.md) |
...
| `test-taxonomy-v2` | テスト分類 v2（子: テスト軸の Schema / Guard / Operations / Legacy 撤退） | **in_progress** | `taxonomy-v2` | 46/63 (73%) | [`projects/test-taxonomy-v2/AI_CONTEXT.md`](../../../projects/test-taxonomy-v2/AI_CONTEXT.md) |
