...
| 全 project の checked checkbox 総数 | 628 |
...
| `widget-registry-simplification` | widget registry 簡素化（SP-B） | **in_progress** | `architecture-debt-recovery` | 4/22 (18%) | [`projects/widget-registry-simplification/AI_CONTEXT.md`](../../../projects/widget-registry-simplification/AI_CONTEXT.md) |
