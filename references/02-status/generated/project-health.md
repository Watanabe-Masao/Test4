...
| `calendar-modal-route-unification` | カレンダーモーダル正規ルート統一 — useDayDetailPlan の bundle / paired handler 経由化 | **in_progress** | — | 0/17 (0%) | [`projects/calendar-modal-route-unification/AI_CONTEXT.md`](../../../projects/calendar-modal-route-unification/AI_CONTEXT.md) |
