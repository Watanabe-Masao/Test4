...
| 全 project の checked checkbox 総数 | 254 |
...
| `test-signal-integrity` | AAG Test Signal Integrity — 品質シグナル保全と False Green 防止 | **in_progress** | 14/34 (41%) | [`projects/test-signal-integrity/AI_CONTEXT.md`](../../../projects/test-signal-integrity/AI_CONTEXT.md) |
