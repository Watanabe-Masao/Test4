...
| 全 project の checked checkbox 総数 | 632 |
...
| `widget-registry-simplification` | widget registry 簡素化（SP-B） | **in_progress** | `architecture-debt-recovery` | 8/22 (36%) | [`projects/widget-registry-simplification/AI_CONTEXT.md`](../../../projects/widget-registry-simplification/AI_CONTEXT.md) |
