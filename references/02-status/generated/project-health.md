...
| 全 project の checked checkbox 総数 | 600 |
...
| `widget-context-boundary` | widget / ctx 型境界再構築（SP-A） | **in_progress** | `architecture-debt-recovery` | 5/35 (14%) | [`projects/widget-context-boundary/AI_CONTEXT.md`](../../../projects/widget-context-boundary/AI_CONTEXT.md) |
