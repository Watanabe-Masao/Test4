...
| 全 project の required checkbox 総数 | 983 |
...
|---|---|---|---|---|---|
| `aag-bidirectional-integrity` | AAG Meta 確立 + AAG Core 5 層 × 縦スライス matrix 化 + 双方向 integrity 機械化 + 表示 rule 製本化 | **in_progress** | — | 20/122 (16%) | [`projects/aag-bidirectional-integrity/AI_CONTEXT.md`](../../../projects/aag-bidirectional-integrity/AI_CONTEXT.md) |
