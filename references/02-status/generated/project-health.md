...
| 全 project の required checkbox 総数 | 880 |
| 全 project の checked checkbox 総数 | 630 |
...
| `phased-content-specs-rollout` | Content Spec System 段階展開計画 (SHELL) | **in_progress** | `architecture-debt-recovery` | 6/66 (9%) | [`projects/phased-content-specs-rollout/AI_CONTEXT.md`](../../../projects/phased-content-specs-rollout/AI_CONTEXT.md) |
