...
| 全 project の required checkbox 総数 | 543 |
| 全 project の checked checkbox 総数 | 474 |
...
| `presentation-cts-surface-ratchetdown` | presentation 層の CategoryTimeSalesRecord 直接 import を 32→0 に ratchet-down | **in_progress** | — | 17/18 (94%) | [`projects/presentation-cts-surface-ratchetdown/AI_CONTEXT.md`](../../../projects/presentation-cts-surface-ratchetdown/AI_CONTEXT.md) |
