...
| `unify-period-analysis` | 期間分析統合（固定期間を自由期間プリセットに） | **in_progress** | — | 38/57 (67%) | [`projects/unify-period-analysis/AI_CONTEXT.md`](../../../projects/unify-period-analysis/AI_CONTEXT.md) |
