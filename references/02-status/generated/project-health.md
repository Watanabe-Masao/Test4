...
| 全 project の checked checkbox 総数 | 315 |
...
| `unify-period-analysis` | 期間分析統合（固定期間を自由期間プリセットに） | **in_progress** | — | 29/49 (59%) | [`projects/unify-period-analysis/AI_CONTEXT.md`](../../../projects/unify-period-analysis/AI_CONTEXT.md) |
