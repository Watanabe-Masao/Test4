...
| 全 project の checked checkbox 総数 | 537 |
...
| `architecture-debt-recovery` | アーキテクチャ負債回収（widget 起点の大型改修） | **in_progress** | — | 24/73 (33%) | [`projects/architecture-debt-recovery/AI_CONTEXT.md`](../../../projects/architecture-debt-recovery/AI_CONTEXT.md) |
