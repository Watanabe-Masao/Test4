...
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 32/32 / active-debt 例外数: 1/12 / reviewPolicy 設定済みルール数: 144/92 / sunsetCondition 設定済みルール数: 13/9 / active-debt で createdAt 設定済み: 1/1 |
| **Rule Efficacy** | OK | protectedHarm 設定済みルール数: 81 / 高例外圧ルール数（≥10 件）: 0/3 / renewalCount 合計: 0/10 |
