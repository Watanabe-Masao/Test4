...
| **ガード強度** | OK | ガードテストファイル数: 112/30 / レビュー専用タグ数: 0/5 |
| **性能** | OK | JS バンドル合計サイズ: 6602/7000 / メインバンドルサイズ: 2386/2500 / ECharts バンドルサイズ: 919/1000 |
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 0/32 / active-debt 例外数: 2/12 / reviewPolicy 設定済みルール数: 160/92 / sunsetCondition 設定済みルール数: 29/9 / active-debt で createdAt 設定済み: 2/1 |
| **Rule Efficacy** | OK | protectedHarm 設定済みルール数: 97 / 高例外圧ルール数（≥10 件）: 0/3 / renewalCount 合計: 0/10 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 791 | 794 | +3 ! |
