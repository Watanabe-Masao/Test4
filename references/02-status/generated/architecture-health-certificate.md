...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 9/20 (+1) / in_progress な project 数（open required checkbox あり）: 8/20 (+1) / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 21/100 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の required checkbox 総数 | 814 | 880 | +66 ! |
| 全 project の checked checkbox 総数 | 624 | 630 | +6 ! |
| active project 数（archive 未実施を含む） | 8 | 9 | +1 ! |
| in_progress な project 数（open required checkbox あり） | 7 | 8 | +1 ! |
| サブ project 数（parent フィールドあり） | 6 | 7 | +1 ! |
