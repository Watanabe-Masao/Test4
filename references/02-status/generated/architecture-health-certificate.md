...
| **ガード強度** | OK | ガードテストファイル数: 87/30 / レビュー専用タグ数: 0/5 |
| **性能** | OK | JS バンドル合計サイズ: 6600/7000 / メインバンドルサイズ: 2388/2500 / ECharts バンドルサイズ: 919/1000 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 588 | 591 | +3 ! |
