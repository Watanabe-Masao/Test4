...
| **ガード強度** | OK | ガードテストファイル数: 79/30 (+1) / レビュー専用タグ数: 0/5 |
| **性能** | OK | JS バンドル合計サイズ: 6630/7000 (-4) / メインバンドルサイズ: 2329/2500 (+3) / ECharts バンドルサイズ: 919/1000 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| メインバンドルサイズ | 2326 | 2329 | +3 ! |
| JS バンドル合計サイズ | 6634 | 6630 | -4 + |
| ガードテストファイル数 | 78 | 79 | +1 + |
