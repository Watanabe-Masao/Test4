...
| 指標 | 状態 | 詳細 |
|---|---|---|
| **例外圧** | OK | 許可リスト総エントリ数: 15/20 / Frozen リスト非ゼロ: 0/0 / Active リスト数: 8/10 |
...
| **ガード強度** | OK | ガードテストファイル数: 38/30 / レビュー専用タグ数: 0/5 |
| **性能** | OK | JS バンドル合計サイズ: 6490/7000 / メインバンドルサイズ: 2218/2500 / ECharts バンドルサイズ: 919/1000 |
