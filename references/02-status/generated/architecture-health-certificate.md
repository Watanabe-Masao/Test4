...
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 0/32 / active-debt 例外数: 1/12 / reviewPolicy 設定済みルール数: 155/92 / sunsetCondition 設定済みルール数: 24/9 / active-debt で createdAt 設定済み: 1/1 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 827 | 835 | +8 ! |
