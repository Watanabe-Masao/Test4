...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 7/20 (-1) / in_progress な project 数（open required checkbox あり）: 6/20 (-1) / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 23/100 (+1) |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| archived project 数（projects/completed/ 配下） | 22 | 23 | +1 ! |
| active project 数（archive 未実施を含む） | 8 | 7 | -1 + |
| in_progress な project 数（open required checkbox あり） | 7 | 6 | -1 + |
