...
| **ガード強度** | OK | ガードテストファイル数: 43/30 / レビュー専用タグ数: 0/5 |
| **性能** | OK | JS バンドル合計サイズ: 6496/7000 (+1) / メインバンドルサイズ: 2225/2500 (+1) / ECharts バンドルサイズ: 919/1000 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| JS バンドル合計サイズ | 6495 | 6496 | +1 ! |
| メインバンドルサイズ | 2224 | 2225 | +1 ! |
| Doc 更新義務違反数 | 2 | 1 | -1 + |
