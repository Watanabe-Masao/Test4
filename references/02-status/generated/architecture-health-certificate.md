...
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 27/27 / active-debt 例外数: 13/13 (-3) / reviewPolicy 設定済みルール数: 84/84 / sunsetCondition 設定済みルール数: 9/9 / active-debt で createdAt 設定済み: 13/13 (-3) |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| active-debt 例外数 | 16 | 13 | -3 + |
| active-debt で createdAt 設定済み | 16 | 13 | -3 + |
