...
| **性能** | OK | JS バンドル合計サイズ: 6494/7000 (-1) / メインバンドルサイズ: 2219/2500 (-1) / ECharts バンドルサイズ: 919/1000 |
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 27/27 / active-debt 例外数: 3/3 (-2) / reviewPolicy 設定済みルール数: 84/84 / sunsetCondition 設定済みルール数: 9/9 / active-debt で createdAt 設定済み: 3/3 (-2) |
| **Rule Efficacy** | OK | protectedHarm 設定済みルール数: 24 / 高例外圧ルール数（≥10 件）: 0/3 / renewalCount 合計: 0/10 |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| active-debt 例外数 | 5 | 3 | -2 + |
| active-debt で createdAt 設定済み | 5 | 3 | -2 + |
| JS バンドル合計サイズ | 6495 | 6494 | -1 + |
| メインバンドルサイズ | 2220 | 2219 | -1 + |
