...
| **ガード強度** | OK | ガードテストファイル数: 127/30 / レビュー専用タグ数: 0/5 |
...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 4/20 (-2) / in_progress な project 数（open required checkbox あり）: 3/20 (-2) / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 36/100 (+2) |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 1132 | 1137 | +5 ! |
| archived project 数（projects/completed/ 配下） | 34 | 36 | +2 ! |
| 全 project の required checkbox 総数 | 1212 | 1203 | -9 + |
| active project 数（archive 未実施を含む） | 6 | 4 | -2 + |
| in_progress な project 数（open required checkbox あり） | 5 | 3 | -2 + |
