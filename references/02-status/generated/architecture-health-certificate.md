...
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 32/32 / active-debt 例外数: 11/12 (+1) / reviewPolicy 設定済みルール数: 140/92 / sunsetCondition 設定済みルール数: 9/9 / active-debt で createdAt 設定済み: 11/1 (+1) |
...
|---|---|---|---|
| Doc 更新義務違反数 | 0 | 1 | +1 ! |
| active-debt 例外数 | 10 | 11 | +1 ! |
| active-debt で createdAt 設定済み | 10 | 11 | +1 ! |
