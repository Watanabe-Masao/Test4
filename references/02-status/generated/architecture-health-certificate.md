...
| **性能** | OK | JS バンドル合計サイズ: 6543/7000 (+6) / メインバンドルサイズ: 2242/2500 (+6) / ECharts バンドルサイズ: 919/1000 |
...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 5/20 / in_progress な project 数（open required checkbox あり）: 4/20 / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 16/100 |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 476 | 503 | +27 ! |
| JS バンドル合計サイズ | 6537 | 6543 | +6 ! |
| メインバンドルサイズ | 2236 | 2242 | +6 ! |
