...
| **性能** | OK | JS バンドル合計サイズ: 6495/7000 / メインバンドルサイズ: 2220/2500 / ECharts バンドルサイズ: 919/1000 |
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 27/27 / active-debt 例外数: 7/7 (-3) / reviewPolicy 設定済みルール数: 84/84 / sunsetCondition 設定済みルール数: 9/9 / active-debt で createdAt 設定済み: 7/7 (-3) |
| **Rule Efficacy** | OK | protectedHarm 設定済みルール数: 24 / 高例外圧ルール数（≥10 件）: 0/3 (-1) / renewalCount 合計: 0/10 |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| active-debt 例外数 | 10 | 7 | -3 + |
| active-debt で createdAt 設定済み | 10 | 7 | -3 + |
| 高例外圧ルール数（≥10 件） | 1 | 0 | -1 + |
