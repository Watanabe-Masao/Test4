...
| **ガード強度** | OK | ガードテストファイル数: 125/30 / レビュー専用タグ数: 0/5 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の required checkbox 総数 | 1184 | 1185 | +1 ! |
| 全 project の checked checkbox 総数 | 1118 | 1119 | +1 ! |
