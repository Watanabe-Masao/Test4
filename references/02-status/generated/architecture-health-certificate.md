...
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 32/32 / active-debt 例外数: 1/1 / reviewPolicy 設定済みルール数: 94/91 / sunsetCondition 設定済みルール数: 9/9 / active-debt で createdAt 設定済み: 1/1 |
| **Rule Efficacy** | OK | protectedHarm 設定済みルール数: 34 / 高例外圧ルール数（≥10 件）: 0/3 / renewalCount 合計: 0/10 |
