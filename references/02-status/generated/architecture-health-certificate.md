...
| **性能** | OK | JS バンドル合計サイズ: 6544/7000 / メインバンドルサイズ: 2243/2500 / ECharts バンドルサイズ: 919/1000 |
...
| **Project Governance** | OK | active project 数（archive 未実施を含む）: 6/20 (+3) / in_progress な project 数（open required checkbox あり）: 5/20 (+3) / checklist 完了済みだが archive 未実施の project 数: 0/0 / archived project 数（projects/completed/ 配下）: 18/100 |

## Recent Changes

| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の required checkbox 総数 | 502 | 607 | +105 ! |
| active project 数（archive 未実施を含む） | 3 | 6 | +3 ! |
| in_progress な project 数（open required checkbox あり） | 2 | 5 | +3 ! |
| サブ project 数（parent フィールドあり） | 1 | 3 | +2 ! |
