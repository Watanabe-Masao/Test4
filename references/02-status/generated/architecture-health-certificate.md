...
| **ガード強度** | OK | ガードテストファイル数: 116/30 / レビュー専用タグ数: 0/5 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 842 | 848 | +6 ! |
| 全 project の required checkbox 総数 | 927 | 928 | +1 ! |
