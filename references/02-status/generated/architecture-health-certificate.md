...
| **性能** | OK | JS バンドル合計サイズ: 6577/7000 / メインバンドルサイズ: 2257/2500 / ECharts バンドルサイズ: 919/1000 |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 全 project の checked checkbox 総数 | 495 | 499 | +4 ! |
| 全 project の required checkbox 総数 | 650 | 653 | +3 ! |
