...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| 総 Architecture Rule 数 | 164 | 165 | +1 ! |
| fixNow=now ルール数（即修正） | 85 | 86 | +1 ! |
| reviewPolicy 設定済みルール数 | 164 | 165 | +1 ! |
| sunsetCondition 設定済みルール数 | 33 | 34 | +1 ! |
| protectedHarm 設定済みルール数 | 101 | 102 | +1 ! |
| ガードテストファイル数 | 118 | 119 | +1 + |
