...
| **性能** | OK | JS バンドル合計サイズ: 6495/7000 (+2) / メインバンドルサイズ: 2220/2500 (+1) / ECharts バンドルサイズ: 919/1000 |
| **Temporal Governance** | OK | review overdue ルール数: 0/0 / heuristic + gate ルール数: 27/27 / active-debt 例外数: 10/10 (-3) / reviewPolicy 設定済みルール数: 84/84 / sunsetCondition 設定済みルール数: 9/9 / active-debt で createdAt 設定済み: 10/10 (-3) |
...
| 指標 | 前回 | 今回 | 変化 |
|---|---|---|---|
| JS バンドル合計サイズ | 6493 | 6495 | +2 ! |
| メインバンドルサイズ | 2219 | 2220 | +1 ! |
| active-debt 例外数 | 13 | 10 | -3 + |
| active-debt で createdAt 設定済み | 13 | 10 | -3 + |
