...
| `references/03-implementation/ar-rule-binding-protocol.md` | AR-rule binding 品質基準 protocol (Project B Phase 3 deliverable、本 registry の rule entry も protocol §2 を満たす必要がある)              |
