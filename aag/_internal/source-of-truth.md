...
| `references/04-tracking/generated/architecture-health.md` | 同上 | 同上 |
| `references/04-tracking/generated/architecture-health-certificate.md` | 同上 | 同上 |
| `references/04-tracking/generated/project-health.json` | `projects/<id>/checklist.md` + config + AAG-COA | 同上 |
| `references/04-tracking/generated/project-health.md` | 同上 | 同上 |
...
| 直近の主要変更 | `references/04-tracking/recent-changes.md` | 各 doc の per-doc 履歴を集約 |
...
- **件数 / 現在値** (= 派生物に集約) → `references/04-tracking/generated/architecture-health.md`
