...
> 生成: 2026-04-27T10:50:55.597Z — 正本: `docs/contracts/test-contract.json` — 6/6 契約満足
...
#### v1 / TSIG 撤去期限（Phase 7 v1/TSIG Deprecation、2026-04-27 確定）

| 軸 | 撤退対象 | `@deprecated since` | `@expiresAt` | Phase 8 物理削除 |
|---|---|---|---|---|
| 責務軸 (R:\*) | `responsibilityTagRegistry.ts` + `responsibilityTagGuard.test.ts` | 2026-04-27 | **2026-07-26** | v2 R:tag (10 件、L5 Guarded) で完全置換 |
| テスト軸 (T:\*) | `testSignalIntegrityGuard.test.ts`（TSIG-TEST-01 / TSIG-TEST-04 / TSIG-COMP-03）| 2026-04-27 | **2026-07-26** | v2 T:kind (15 件、L5 Guarded) で完全置換 |

- v2 vocabulary は **新規 file で必須**（v1 / TSIG vocabulary の新規使用禁止）
- 撤退期限後の `@deprecated` は `deprecatedMetadataGuard` DM2 が hard fail で検出
...
| 後方互換負債 | OK | 0/3 / 2/3 |
| 複雑性圧 | OK | 0/5 / 10/10 / 25/30 |
| 境界健全性 | OK | 0/0 / 0/0 |
| ガード強度 | OK | 106/30 / 0/5 |
| 性能 | OK | 6602/7000 / 2386/2500 / 919/1000 |
| Temporal Governance | OK | 0/0 / 0/32 / 2/12 / 155/92 / 24/9 / 2/1 |
| Rule Efficacy | OK | 92 / 0/3 / 0/10 |
| Project Governance | OK | 7/20 / 6/20 / 0/0 / 24/100 |


> 生成: 2026-04-27T10:50:55.590Z — 正本: `references/02-status/generated/architecture-health.json`
