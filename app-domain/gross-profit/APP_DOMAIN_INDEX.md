...
3. 必要に応じて業務値定義書（現在は `references/01-foundation/*-definition.md` に配置）

## 関連ファイル（現在の配置）

| App Domain 資産 | 現在の配置 | 備考 |
|---|---|---|
| 業務値定義書（12 ファイル） | `references/01-foundation/*-definition.md` | 将来 App Domain 移動候補 |
| 意味分類ポリシー | `references/01-foundation/semantic-classification-policy.md` | Mixed（概念=Core、具体適用=App） |
| 契約定義ポリシー | `references/03-implementation/contract-definition-policy.md` | App Domain |
...
| 不変条件カタログ | `references/03-implementation/invariant-catalog.md` | App Domain |
