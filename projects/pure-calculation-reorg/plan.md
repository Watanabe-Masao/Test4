...
- **ファイル**: `references/01-foundation/semantic-classification-policy.md`（新規）
...
- **ファイル**: `references/01-foundation/engine-boundary-policy.md`
...
- **ファイル**: `references/04-tracking/authoritative-term-sweep.md`（新規）
...
grep -l "Business Semantic Core" references/01-foundation/semantic-classification-policy.md
grep -l "business-authoritative" references/01-foundation/engine-boundary-policy.md
...
- **ファイル**: `references/03-implementation/semantic-inventory-procedure.md`（新規）
- **内容**: Phase 1 手順書ドラフト（判定質問セット Q1-Q8、重要ルール、出力フォーマット）

#### 1-2. inventory 一覧

- **ファイル**: `references/04-tracking/semantic-inventory.yaml`（新規）
...
- **ファイル**: `references/03-implementation/directory-registry-ownership-policy.md`（新規）
...
- **ファイル**: `references/03-implementation/contract-definition-policy.md`（新規）
...
| ファイル | Phase | 変更内容 |
|---------|-------|---------|
| `references/01-foundation/semantic-classification-policy.md` | 0 | 新規（定義書） |
| `references/01-foundation/engine-boundary-policy.md` | 0 | 用語整合 |
| `references/04-tracking/authoritative-term-sweep.md` | 0 | 新規（用語スイープ結果） |
| `CLAUDE.md` | 0 | 参照追加 + authoritative 禁止 |
| `references/03-implementation/semantic-inventory-procedure.md` | 1 | 新規（手順書） |
| `references/04-tracking/semantic-inventory.yaml` | 1 | 新規（inventory） |
| `references/03-implementation/directory-registry-ownership-policy.md` | 2 | 新規（方針書） |
...
| `references/03-implementation/contract-definition-policy.md` | 3 | 新規（契約定義書） |
...
| `references/03-implementation/current-maintenance-policy.md` | 4 | 新規（current 保守方針） |
