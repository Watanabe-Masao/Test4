...
- **次 session**: Project A〜D bootstrap (1 session = 1 project、仮称、bootstrap 時に project id 確定) → 本 project は archive プロセスへ migrate

canonical 計画 doc は本 project の `plan.md`。parent: なし。後続: Project A〜D (仮称、next session で bootstrap)。
