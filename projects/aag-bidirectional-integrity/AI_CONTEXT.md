...
### 4 層 drill-down 構造 + 縦スライス (AAG architecture pattern)
...
articulate される (詳細: plan §3.1 matrix view)。

- **AAG Meta** = Layer 0 + 1 (`aag/meta.md` を新規 Create で articulate)
- **AAG Core** = Layer 2 + 3 (8 doc + rule + guard + allowlist + health の集合体)
