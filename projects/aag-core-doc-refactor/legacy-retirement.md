...
|---|---|---|---|
| `references/99-archive/adaptive-architecture-governance.md` | **Split + Archive** | 戦略マスター → `aag/strategy.md` / 文化論 → `aag/strategy.md` or `aag/meta.md` / 旧 4 層 → 99-archive / バージョン履歴 → per-doc 分散 | Phase 2 で Split、Phase 5 で archive |
