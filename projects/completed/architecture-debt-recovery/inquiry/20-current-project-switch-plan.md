...
| 入力 | `CURRENT_PROJECT.md`、`projects/architecture-debt-recovery/config/project.json`、`projects/completed/budget-achievement-simulator/config/project.json`、`inquiry/19`、`plan.md §7` |
...
steps:
  - step1:
      action: projects/completed/budget-achievement-simulator/SUMMARY.md を作成
      内容: |
        - 完了日
        - reboot 成果サマリ
  ...
  - step3:
      action: 物理移動
      from: projects/completed/budget-achievement-simulator/
