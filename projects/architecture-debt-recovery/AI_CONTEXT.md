...
|---|---|
| `projects/budget-achievement-simulator` | widget 登録システムの 2 WidgetDef 型・InsightData 結合・complexity hotspot 7 項目・ctx 非対称 |
...
5. `projects/budget-achievement-simulator/HANDOFF.md`（informed-by 先の到達点）
6. 必要に応じて:
...
| `projects/budget-achievement-simulator/` | informed-by 先（findings の提供元） |
