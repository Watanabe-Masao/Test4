...
| 入力 | `projects/completed/budget-achievement-simulator/HANDOFF.md` / `AI_CONTEXT.md` / `plan.md` / `checklist.md` / `config/project.json` |
...
3. `projects/completed/budget-achievement-simulator/` を `projects/completed/budget-achievement-simulator/` に物理移動（Phase 6 の initial PR）
...
archive-budget-achievement-simulator:
  steps:
    ...
    - step4: projects/completed/budget-achievement-simulator/ を projects/completed/budget-achievement-simulator/ に物理移動
...
- 関連: `inquiry/18`（sub-project map）、`inquiry/20`（CURRENT_PROJECT 切替計画）、`inquiry/21`（spawn sequence）、`projects/completed/budget-achievement-simulator/HANDOFF.md`
