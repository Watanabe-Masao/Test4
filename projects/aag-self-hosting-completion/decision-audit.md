...
- judgementCommit: `<実 sha = 本 R6a 実装 commit>`
- preJudgementCommit: `a72134a` (= R0-R5 + hot fix merged to main + branch synced)
- judgementTag: `aag-self-hosting-completion/DA-α-007a-judgement` (= 本 commit に landing 予定)
- rollbackTag: `aag-self-hosting-completion/DA-α-007a-rollback-target` (= `a72134a` に landing 済)
- implementationCommits:
  - `<本 commit sha>` — R6a 全実装
