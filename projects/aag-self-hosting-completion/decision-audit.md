...
- judgementCommit: `<本 commit sha>` (= R1 全実装 commit、本 entry landing 後に記入)
- preJudgementCommit: `2ac8009` (= R0 完了 + DA-α-001 Lineage 実 sha update commit)
- judgementTag: `aag-self-hosting-completion/DA-α-002-judgement` (本 commit に annotated tag landing)
- rollbackTag: `aag-self-hosting-completion/DA-α-002-rollback-target` (`2ac8009` に annotated tag landing 済)
- implementationCommits:
  - `<本 commit sha>` — R1 全実装 (= aag/_internal/ + aag/_framework/ skeleton + 9 doc 物理移動 + 51 inbound update + guard / collector path + doc-registry / manifest + aagBoundaryGuard 新設 + DA-α-002 entry landing)
