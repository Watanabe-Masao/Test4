...
- preJudgementCommit: `c9f60b8`
- judgementTag: `aag-self-hosting-completion/DA-α-003-judgement`
- rollbackTag: `aag-self-hosting-completion/DA-α-003-rollback-target` (= `c9f60b8` に landing 済)
- implementationCommits:
  - `<本 commit sha>` — R2 全実装
