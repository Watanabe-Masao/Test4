...
- **場所**: `projects/aag-self-hosting-completion/doc-improvement-backlog.md` + 本 `discovery-log.md`
...
- **場所**: `projects/aag-self-hosting-completion/doc-improvement-backlog.md` (4 系統 lens articulate) + 関連 doc (`references/05-aag-interface/operations/projectization-policy.md` / `project-checklist-governance.md`)
