...
- **Phase A〜G**: 完了 (reboot 文脈正本化 / mock scenario / View 分離 /
  state 接続 / source adapter 新設 / 実データ接続 / widget 組込み整理)
- **Phase H**: テストと仕上げ (VM test / hook test / visual / E2E / health)
