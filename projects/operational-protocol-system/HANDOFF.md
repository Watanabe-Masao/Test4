...
不可侵原則 1 違反。本 project は AAG 上に薄く載せる operational layer のみ。AAG 内部 (`aag/_internal/` + `aag/core/`) は **touch しない**、参照のみ。drawer (`references/03-guides/decision-articulation-patterns.md`) も改変しない、引用のみ。
