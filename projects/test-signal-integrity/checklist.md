...
* [ ] TSIG-COMP-01: 理由なし `@ts-ignore` / `@ts-expect-error` を検知して block する guard を実装する
* [ ] TSIG-COMP-02: 理由なし `eslint-disable` を検知して block する guard を実装する
* [ ] TSIG-COMP-03: unused suppress escape の初期対象を検知して block する guard を実装する
