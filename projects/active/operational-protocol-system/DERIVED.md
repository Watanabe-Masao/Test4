...
- `references/05-aag-interface/operations/new-project-bootstrap-guide.md` — bootstrap 手順全体
- `references/05-aag-interface/operations/project-checklist-governance.md` §10 — 必須セット bootstrap
