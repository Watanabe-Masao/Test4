...
| 領域                        | 成果物                                                                                                                            |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **Common Inventory Schema** | 親 `projects/active/taxonomy-v2/plan.md` §Common Inventory Schema（CanonEntry shape） — 両子 Phase 0 出力の正本 shape                    |
...
cat projects/active/taxonomy-v2/HANDOFF.md                    # ← 本ファイル
cat projects/active/taxonomy-v2/checklist.md                  # Phase 進捗
...
| `projects/active/pure-calculation-reorg/HANDOFF.md`    | 姉妹 project（同じ制度化フレーム）                      |
