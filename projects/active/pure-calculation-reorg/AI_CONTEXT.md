...
- Presentation 品質強化 → [`projects/active/presentation-quality-hardening`](../presentation-quality-hardening/AI_CONTEXT.md)
...
| **ExecutionOverlay**（Project Overlay 正本） | `projects/active/pure-calculation-reorg/aag/execution-overlay.ts` | この案件でどう扱うか（fixNow / priority / reviewCadence） |
