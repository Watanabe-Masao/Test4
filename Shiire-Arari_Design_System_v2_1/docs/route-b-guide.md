# Route B — `references/04-design-system/` への配置手順
...
`references/04-design-system/` 以下に正本として保管する。
...
- `references/04-design-system/` 新設 (44 ファイル)
...
- [ ] references/04-design-system/ ディレクトリ作成
...
# 6. 確認
ls references/04-design-system/
...
```json
{
  ...
  "docs": [
    { "path": "references/04-design-system/README.md", "label": "Design System v2.1 正本" },
    { "path": "references/04-design-system/docs/tokens.md", "label": "トークン一覧" },
    { "path": "references/04-design-system/docs/theme-object.md", "label": "AppTheme オブジェクト" },
    { "path": "references/04-design-system/docs/chart-semantic-colors.md", "label": "業務概念 → 色 マップ" },
    { "path": "references/04-design-system/docs/category-gradients.md", "label": "カテゴリグラデーション" },
    { "path": "references/04-design-system/docs/trend-helpers.md", "label": "sc.* トレンド判定" },
    { "path": "references/04-design-system/docs/echarts-integration.md", "label": "ECharts 統合" },
    { "path": "references/04-design-system/docs/content-and-voice.md", "label": "コンテンツ・トーン" },
    { "path": "references/04-design-system/docs/visual-foundations.md", "label": "視覚基礎" },
    { "path": "references/04-design-system/docs/iconography.md", "label": "アイコン運用" },
    { "path": "references/04-design-system/docs/v2-to-v2.1-changes.md", "label": "v2.0 → v2.1 変更点" },
    { "path": "references/04-design-system/docs/route-b-guide.md", "label": "配置手順 (本 guide)" }
  ]
}
```
...
```
... design-system-v2.1-asset (YYYY-MM-DD): DS v2.1 を references/04-design-system/
...
```
docs: Shiire-Arari Design System v2.1 を references/04-design-system/ に追加
...
Shiire-Arari Design System v2.1 を `references/04-design-system/` に
...
- [ ] `references/04-design-system/colors_and_type.css` の `--c-primary` 等
...
将来組み込むときに流用できるため）。削除したい場合は `references/04-design-system/`
